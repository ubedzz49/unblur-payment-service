...
// distinct tracking table and lock id from user-service (7264991), matching-service (7264992),
// doubt-service (7264993) and resolution-service (7264994), since this shares the same database
// -- must never collide
const TRACKING_TABLE = "payment_service_schema_migrations";
const MIGRATION_LOCK_ID = 7264995;
